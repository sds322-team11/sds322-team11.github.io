...
3. Hypothesis 3-There is a significant difference in sale price of houses that have finished garages (3) vs those houses that have unfinished garages (1).
```{R}
data2<-data %>%
...
4. Hypothesis 4- Houses with a garage that can hold 3 or more cars have on average a higher sales price.
```{R}
hyp4<-data %>%
